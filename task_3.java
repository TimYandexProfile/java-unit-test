...
public class CheckIsAdultTest {
    ...
    @Parameterized.Parameters(name = "Age: {0}, Result: {1}") // Пометь метод аннотацией для параметров
    ...
    public void checkIsAdultWhenAgeThenResult() {
        ...
        assertEquals("Неправильный результат для возраста: " + age, result, isAdult);
    }
}